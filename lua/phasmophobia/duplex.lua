...
function duplex_set(duplex, position, value)
	...
	assert(value ~= nil, "ID10T-9: Attempt to set a nil value in duplex. Use PHASMOPHOBIA._DuplexUnset instead.")
...
--globals
PHASMOPHOBIA._DuplexDestroy = duplex_destroy
PHASMOPHOBIA._DuplexExtract = duplex_extract
PHASMOPHOBIA._DuplexInheritEntry = duplex_inherit_entry
PHASMOPHOBIA._DuplexInsert = duplex_insert
PHASMOPHOBIA._DuplexIsFooplex = duplex_is_fooplex
PHASMOPHOBIA._DuplexMake = duplex_make
PHASMOPHOBIA._DuplexMakeFooplex = duplex_make_fooplex
PHASMOPHOBIA._DuplexRemove = duplex_remove
PHASMOPHOBIA._DuplexSet = duplex_set
PHASMOPHOBIA._DuplexSort = duplex_sort
PHASMOPHOBIA._DuplexUnset = duplex_unset

--[[ copy paste this in your locals header

local duplex_destroy = PHASMOPHOBIA._DuplexDestroy
local duplex_extract = PHASMOPHOBIA._DuplexExtract
local duplex_inherit_entry = PHASMOPHOBIA._DuplexInheritEntry
local duplex_insert = PHASMOPHOBIA._DuplexInsert
local duplex_is_fooplex = PHASMOPHOBIA._DuplexIsFooplex
local duplex_make = PHASMOPHOBIA._DuplexMake
local duplex_make_fooplex = PHASMOPHOBIA._DuplexMakeFooplex
local duplex_remove = PHASMOPHOBIA._DuplexRemove
local duplex_set = PHASMOPHOBIA._DuplexSet
local duplex_sort = PHASMOPHOBIA._DuplexSort
local duplex_unset = PHASMOPHOBIA._DuplexUnset
